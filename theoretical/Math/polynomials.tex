...
\begin{itemize}
    \item \textbf{Fast Fourier Transform (FFT): } An efficient algorithm to compute the discrete Fourier transform (DFT) and its inverse, which can be used for polynomial multiplication.
